 ...
 *
 * @author: songningning
 * @date: created in 2018/4/4 14:54
 * @modified: by
 */
public class Modbus4jUtils {
    ...
    public static void batchRead() throws ModbusTransportException, ErrorResponseException, ModbusInitException {
        ...
        batch.addLocator(0, BaseLocator.inputRegister(1, 1, DataType.TWO_BYTE_INT_UNSIGNED));
        batch.addLocator(1, BaseLocator.inputRegister(1, 2, DataType.TWO_BYTE_INT_UNSIGNED));
...
//
            // 04测试
            Number v041 = readInputRegisters(1, 2, DataType.TWO_BYTE_INT_UNSIGNED);//
            Number v042 = readInputRegisters(1, 1, DataType.TWO_BYTE_INT_UNSIGNED);//
